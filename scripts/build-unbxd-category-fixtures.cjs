/**
 * Writes unbxd-search-fencing.json and unbxd-search-cat-litter.json for category-routed mocks.
 * Run: node scripts/build-unbxd-category-fixtures.cjs
 */
...
function fencingStub(uid, mid, title) {
  ...
  return {
    ...
    title,
    description: '',
    productUrl: `https://farmstore-modern.us/product/fencing/wire-fencing-accessories/other/${slug}-${uid}`,
    ...
    variants: [
      vb({
        variantMedusaId: `variant_01KEGBSTUB${uid}V01`,
        variantSku: `FNC-${uid}`,
...
const fencingProducts = [
  ...
  },
  {
    ...
    description: 'Barbed wire for fencing applications.',
    productUrl:
  ...
  },
  {
    ...
    description: 'Fence staples for posts.',
    productUrl:
  ...
  fencingStub('8409', 'prod_01K06D4GN6ESMGG4KSKY329T2N', 'Fencing accessory wire roll 8409'),
  fencingStub('8396', 'prod_01K06D4GNZRK4QEQA124AD7ZZR', 'Fencing accessory wire roll 8396'),
  fencingStub('7913', 'prod_01K06D4FDW6M1VGCXZ89D2RKH3', 'Fencing accessory hardware 7913'),
  fencingStub('7721', 'prod_01K06D4EW6GAZ87DVW4M9W31X2', 'Fencing accessory hardware 7721'),
];
      ...
      list: [
        {
          ...
          displayName: 'Brands',
          position: 2,
          values: ['Hillman', 4, 'Bekaert', 3, 'Grip Rite', 2],
        },
      ],
    },
    multilevel: {
...
const catLitterProducts = [
  ...
  },
  {
    ...
    description: 'Lightweight clumping litter.',
    productUrl:
  ...
  },
  {
    ...
    description: 'Natural clumping wheat litter.',
    productUrl:
...
const root = path.join(__dirname, '..', 'src', 'fixtures');
fs.writeFileSync(path.join(root, 'unbxd-search-fencing.json'), JSON.stringify(fencingFixture, null, 2) + '\n');
fs.writeFileSync(path.join(root, 'unbxd-search-cat-litter.json'), JSON.stringify(catLitterFixture, null, 2) + '\n');
console.log('Wrote unbxd-search-fencing.json and unbxd-search-cat-litter.json');
